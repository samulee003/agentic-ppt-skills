...
const MODES = ['general', 'research-enhanced', 'fast-track'];
...
**Deck:** ${state.deckId} 繚 **Mode:** ${state.mode} 繚 **Engine:** ${state.engine ?? '(not chosen yet ??picked at the deck-prototype gate)'}
